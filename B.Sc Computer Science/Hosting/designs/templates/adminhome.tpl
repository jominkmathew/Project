    ...
    <div class="card-content">
        <div class="row row-group m-0">
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"><td> {$view7}</td> <span class="float-right"><i class="fa fa-shopping-cart"></i></span></h5>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"><td> {$view8}</td> <span class="float-right"><i class="fa fa-shopping-cart"></i></span></h5></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"> <td> {$view10}</td><span class="float-right"><i class="fa fa-eye"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"><td> {$view11}</td> <span class="float-right"><i class="fa fa-envira"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
		  ...
		  <div class="col-12 col-lg-6">
		    <div class="card">
			 <div class="card-body text-center">
				...
				<input class="knob" data-width="175" data-height="175" data-readOnly="true" data-thickness=".2" data-angleoffset="90" data-linecap="round" data-bgcolor="rgba(255, 255, 255, 0.14)" data-fgcolor="#fff" data-max="15000" value="{$view9}"/>
				<hr>
      ...
      <div class="col-12 col-lg-6 col-xl-4">
        <div class="card">
           <div class="card-body">
             <p>Monthly Earning</p>
             <p>Domains</p>
             <h4 class="mb-0"> Rs {if $view5!=null}{$view5}
             {else}0{/if}</h4>
             <small> <i class="zmdi zmdi-long-arrow-up"></i> Since Today</small>
             <hr>
             <p>Packages</p>
             <h4 class="mb-0">Rs  {if $view6!=null}{$view6}
             {else}0{/if}</h4>
             <small><i class="zmdi zmdi-long-arrow-up"></i> Since Today</small>
             <div class="mt-5">
