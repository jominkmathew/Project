<?php /* Smarty version 2.6.26, created on 2020-01-17 10:34:03
         compiled from domainview.tpl */ ?>
...
?>
                    <tr>
                        <td><?php echo $this->_tpl_vars['s']['domaincategory']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['s']['validity']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['s']['amount']; ?>
</td>
                        <td><a href="domainup.php?b=<?php echo $this->_tpl_vars['s']['domkey']; ?>
">Edit</a></td>
                        <td><a href="domaindel.php?b=<?php echo $this->_tpl_vars['s']['domkey']; ?>
">Delete</a></td>
