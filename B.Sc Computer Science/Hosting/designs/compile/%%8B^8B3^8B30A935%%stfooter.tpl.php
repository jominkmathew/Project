<?php /* Smarty version 2.6.26, created on 2020-03-14 07:41:40
         compiled from stfooter.tpl */ ?>
<br><br><br><html>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-6 col-sm-4 col-lg-2">
                        <div class="single-footer-widget mb-80">
                            ...
                            <!-- Footer Nav -->
                            <ul class="footer-nav">
                                <li><a href="staffupdate.php">Edit Profile</a></li>
                    ...
                    <div class="col-6 col-sm-4 col-lg-2">
                        <div class="single-footer-widget mb-80">
                            ...
                            <ul class="footer-nav">
                                ...
                                <li><a href="customer.php">Package</a></li>
                    ...
                    <div class="col-6 col-sm-4 col-lg-2">
                        <div class="single-footer-widget mb-80">
                            ...
                            <!-- Footer Nav -->
                            <ul class="footer-nav">
                                <li><a href="notitbl2.php">Custom Notifications</a></li>
