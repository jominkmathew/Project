<?php /* Smarty version 2.6.26, created on 2020-06-15 08:12:06
...
<head>
    ...
    <!-- Title -->
    <title>The Secure Hosting Service</title>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="top-header-content">
                            <a href="#"><i class="fa fa-phone" aria-hidden="true"></i> <span>Call Us: +91 8921744188></a>
                            <a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> <span>Email: hostingsecure@gmail.com</span></a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading text-center">
                        <h2>Welcome to Secure Hosting</h2>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="video-content-area pr-3 mb-100">
                        <img src="hami/img/bg-img/4.jpg" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        ...
                        <div class="team-thumbnail">
                            <img src="hami/img/bg-img/6.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        <!-- Team Thumbnail -->
                        <div class="team-thumbnail">
                            <img src="hami/img/bg-img/7.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                        <div class="team-content">
                            <h5>Mathews Philip</h5>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        <!-- Team Thumbnail -->
                        <div class="team-thumbnail">
                            <img src="hami/img/bg-img/8.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                        <div class="team-content">
                            <h5>Jomin K Mathew</h5>
                ...
                <div class="col-12">
                    <div class="testimonial-slide owl-carousel">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-content">
                                ...
                                <div class="ratings-icon d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="quote-icon">
                                        <img src="hami/img/core-img/quote.png" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="hami/img/bg-img/10.jpg" alt="">
                                </div>
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="hami/img/bg-img/11.jpg" alt="">
                                </div>
                                <div class="testimonial-title">
                                    <h5>Roy Long</h5>
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="hami/img/bg-img/12.jpg" alt="">
                                </div>
                                <div class="testimonial-title">
                                    <h5>Stephen Colon</h5>
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="hami/img/bg-img/13.jpg" alt="">
                                </div>
                                <div class="testimonial-title">
                                    <h5>Kevin Castro</h5>
    ...
    <section class="hami-support-area">
        ...
        <!-- Support Pattern -->
        <div class="support-pattern" style="background-image: url(hami/img/core-img/support-pattern.png);"></div>
    </section>
    <!-- Support Area End -->
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="copywrite-text">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --><?php echo '
