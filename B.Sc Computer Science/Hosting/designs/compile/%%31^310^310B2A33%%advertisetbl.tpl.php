<?php /* Smarty version 2.6.26, created on 2020-01-24 07:10:16
         compiled from advertisetbl.tpl */ ?>
...
?>
                    <tr>
                        <td><?php echo $this->_tpl_vars['s']['companyname']; ?>
</td>
                        <td><img src="<?php echo $this->_tpl_vars['s']['path']; ?>
" width="200px" height="150px"></td>
                        ...
                        <td><a href="advertiseup.php?b=<?php echo $this->_tpl_vars['s']['advkey']; ?>
" class="btn btn-primary btn-round waves-effect waves-light m-1">Edit</a></td>
                        <td><a href="advertisedel.php?b=<?php echo $this->_tpl_vars['s']['advkey']; ?>
" class="btn btn-danger btn-round waves-effect waves-light m-1">Delete</a></td>
