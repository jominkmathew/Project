<?php /* Smarty version 2.6.26, created on 2020-01-17 12:34:07
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Approval Tables</h4>
...
?>
<tr>
	<td><?php echo $this->_tpl_vars['b']['staffname']; ?>
</td>
	<td><?php echo $this->_tpl_vars['b']['staffid']; ?>
</td>
	<td><?php echo $this->_tpl_vars['b']['contactno']; ?>
</td>
	<td><?php echo $this->_tpl_vars['b']['gender']; ?>
</td>
	<td><?php echo $this->_tpl_vars['b']['dob']; ?>
</td>
	<td><?php echo $this->_tpl_vars['b']['email']; ?>
</td>
	<td><a href="staffaprv.php?b=<?php echo $this->_tpl_vars['b']['loginkey']; ?>
">Approve</a></td>
	<td><a href="staffregt.php?b=<?php echo $this->_tpl_vars['b']['loginkey']; ?>
">Reject</a></td>
</tr>
