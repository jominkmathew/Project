<?php /* Smarty version 2.6.26, created on 2020-03-02 08:39:02
         compiled from staff1.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="container">
            <form method="POST" class="appointment-form" id="appointment-form">
                ...
                <div class="form-group-1">
                    <input type="text" name="staffname" id="title" placeholder="Styaffname" required />
                    <input type="text" name="staffid" id="name" placeholder="Your Name" required />
    ...
    <!-- JS -->
   <?php echo ' <script src="vendor/jquery/jquery.min.js"></script>
