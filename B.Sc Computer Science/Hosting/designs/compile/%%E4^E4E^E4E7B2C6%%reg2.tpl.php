<?php /* Smarty version 2.6.26, created on 2020-03-03 05:53:03
         compiled from reg2.tpl */ ?>
		...
		<div class="left">
			<form action="#" method="post" data-toggle="validator">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="name" id="name" placeholder="First Name" data-error="Enter Your Name" required>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="org" id="organisation" placeholder="Organisation Name" data-error="Enter Organisation Name" required>
					<div class="help-block with-errors"></div>
				</div>
